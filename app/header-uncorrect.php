...
<html lang="ru" dir="ltr">
  <head>
    <meta charset="utf-8">
    <link rel="stylesheet" href="../style/catalog-item.css">
    <title>Mal Corpse -- Каталог</title>
  </head>
  <body class="catalog-item__body">
    <div class="container catalog-item__container">
      <div class="catalog-item">
        <header class="header catalog-item__header">
